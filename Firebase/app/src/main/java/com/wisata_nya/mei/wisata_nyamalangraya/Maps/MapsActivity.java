...
// Daftar Objek Wisata
        ...
        LatLng nama = new LatLng( koorX, koorY);
        mMap.addMarker(new MarkerOptions().position(nama).title("Lokasi Objek Wisata"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(nama));
