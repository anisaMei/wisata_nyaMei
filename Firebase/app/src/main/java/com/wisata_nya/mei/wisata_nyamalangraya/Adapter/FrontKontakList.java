...
public class FrontKontakList extends ArrayAdapter<Kontak> {
private Activity context;
private List<Kontak> kontakList;

    public FrontKontakList(Activity context, List<Kontak> kontakList)
    {
        super(context, R.layout.list_front_kontak, kontakList);
...
public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View listViewItem = inflater.inflate(R.layout.list_front_kontak, null, true);
