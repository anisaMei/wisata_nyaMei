...
public class FrontAboutusList extends ArrayAdapter<AboutUs> {
    private Activity context;
    private List<AboutUs> aboutUsList;

    public FrontAboutusList(Activity context, List<AboutUs> aboutUsList)
    {
        super(context, R.layout.list_front_aboutus, aboutUsList);
...
//        this.wisataList = wisataList;
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View listViewItem = inflater.inflate(R.layout.list_front_aboutus, null, true);
